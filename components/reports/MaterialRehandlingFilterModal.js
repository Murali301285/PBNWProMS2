...
import styles from './MaterialRehandlingFilterModal.module.css';

export default function MaterialRehandlingFilterModal({
    isOpen,
    onClose,
    onApply,
    initialFilters = {}
    ...
    useEffect(() => {
        if (isOpen) {
            setLoading(true);
            fetch('/api/reports/material-rehandling/helpers')
                .then(res => res.json())
                .then(res => {
                    if (res.success) {
                        setOptions(res.data);
        ...
        <div className={styles.modalOverlay}>
            <div className={styles.modalContent}>
                ...
                <div className={styles.modalHeader}>
                    <h2 className={styles.modalTitle}>Material Rehandling Report Filters</h2>
