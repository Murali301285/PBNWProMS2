...
const query = `
ALTER PROCEDURE [dbo].[PMS2_New_Dash_SP_Performance_OperatorPerformance]
    @FromDate DATE,
    @ToDate DATE,
...
BEGIN
    ...
    BEGIN
        ...
        GROUP BY O.OperatorName, O.OperatorId, E.EquipmentName, E.Model, E.Capacity, L.LoadingDate, S.ShiftName
...
async function run() {
    try {
        ...
        console.log('Operator Performance SP Updated successfully with O.OperatorId and grouped correctly.');
        process.exit(0);
    } catch (e) {
        console.error(e);
        process.exit(1);
