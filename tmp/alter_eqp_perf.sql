...
ALTER PROCEDURE [dbo].[PMS2_New_Sp_EquipmentPerformanceReport]
    @Date DATE,
...
BEGIN
    ...
    LEFT JOIN Master.TblEquipmentGroup EG WITH(NOLOCK) ON E.EquipmentGroupId = EG.SlNo
    ...
    GROUP BY E.SlNo, E.CostCenter, E.EquipmentName, EG.Name, AC.Name, AC.SlNo
