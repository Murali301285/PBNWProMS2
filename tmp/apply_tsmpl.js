...
const startStr = '    const handleExportExcel = async () => {';
...
const modified = code.substring(0, startIdx) + newFunc + code.substring(endIdx);
fs.writeFileSync(file, modified);
console.log('TSMPL handleExportExcel replaced successfully!');
