    ...
    try {
        ...
        const result = await pool.request().query(`
            ...
            SELECT 
                ...
                SUM(CASE WHEN L.MaterialId IN (1, 2, 3, 4, 10, 11) THEN L.TotalQty ELSE 0 END) AS OB_Qty_BCM,
                SUM(CASE WHEN L.MaterialId IN (6, 7) THEN L.TotalQty ELSE 0 END) AS Coal_Qty_MT
