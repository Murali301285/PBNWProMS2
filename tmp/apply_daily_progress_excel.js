const fs = require('fs');
const file = 'app/dashboard/reports/daily-progress/page.js';
let code = fs.readFileSync(file, 'utf8');

const match = code.match(/    const handleExportExcel = \(\) => \{[\s\S]*?    \};(?=\s*return \()/);
...
// Delete the unused legacy import
code = code.replace("import * as XLSX from 'xlsx-js-style';\n", "");

fs.writeFileSync(file, code);
console.log('Daily Progress Report handleExportExcel successfully rewriten to native ExcelJS format!');
