...
BEGIN
    ...
    -- Insert OB Removal (MaterialId IN (1, 2)) -> Using SourceId for breakdown instead of PatchId
    INSERT INTO #Stats (SectionId, Category, Date, Qty)
    ...
    JOIN Master.TblEquipmentGroup EG WITH(NOLOCK) ON E.EquipmentGroupId = EG.SlNo AND EG.Name LIKE '%Hauler%'
