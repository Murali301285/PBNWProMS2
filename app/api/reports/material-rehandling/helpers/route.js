...
export async function GET() {
    try {
        console.log("Fetching filter data for Material Rehandling Report...");

        // Note: Rehandling uses similar masters as Loading.
        // Loaders are ActivityId=3 (Loading), Haulers are ActivityId=4 (Hauling)
        const [
            shifts,
            sources,
            destinations,
        ...
        console.error("Material Rehandling Filter Helper Error:", error);
