...
export async function GET(req) {
    try {
        ...
        console.log(`[DASH-OP-PERF] Fetching stats for ${fromDate} to ${toDate} | Model: ${model} | Cap: ${capacity} | Shift: ${shiftId} | Type: ${type}`);
        ...
        const resultSets = await executeStoredProcedure('PMS2_New_Dash_SP_Performance_OperatorPerformance', params);
