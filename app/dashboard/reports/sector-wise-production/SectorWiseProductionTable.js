    ...
    return (
        <div>
            <div className={styles.header}>
                ...
                <div className="mt-2 text-sm text-slate-600 font-medium">Date: {date}</div>
            </div>
            ...
            <div className="overflow-x-auto">
                <table className={styles.table}>
                    ...
                    <tbody>
                            ...
                            return (
                                <React.Fragment key={sector}>
                                    ...
                                    <tr className={styles.sectionHeader}>
                                        <td colSpan="9" className="pl-4 py-2 text-left" style={{ backgroundColor: '#bfdbfe', fontWeight: '800', fontSize: '1rem', color: '#1E1B4B' }}>
                        ...
                        {/* Grand Total */}
                        <tr className="bg-yellow-300 font-bold border-t-2 border-black">
                            <td colSpan="3" className="text-right pr-4 py-3" style={{ fontSize: '1.1rem' }}>Grand Total</td>
