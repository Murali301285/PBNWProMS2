    ...
    return (
        <div>
            ...
            <div className={styles.header}>
                ...
                <div className="text-right text-sm text-red-600 mt-2 font-bold">Date: {date}</div>
            </div>

            {/* SECTION A */}
            <div className="mb-6">
                <h3 className={styles.sectionHeader}>A. SHIFT PRODUCTION DETAILS</h3>
            ...
            {/* SECTION B */}
            <div className="mb-8">
                <h3 className={styles.sectionHeader}>B. TRIP-QUANTITY DETAILS</h3>
            ...
            <div className="col-span-2 mt-4">
                <h3 className={styles.sectionHeader}>D. COAL CRUSHING DETAILS</h3>
                <table className={styles.table}>
                    <thead>
                        <tr className={styles.blueHeader}>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
                {/* F. BLASTING */}
                <div>
                    <h3 className={styles.sectionHeader}>F. BLASTING DETAILS</h3>
                    <table className={styles.table}>
                        <thead>
                            <tr className={styles.blueHeader}>
                                <th>Parameters</th>
                ...
                {/* G. REHANDLING */}
                <div>
                    <h3 className={styles.sectionHeader}>G. ITIZ DUMP REHANDLING</h3>
                    <table className={styles.table}>
                        <thead>
                            <tr className={styles.blueHeader}>
                                <th>Type</th>
